...
\cvitem{}{Robustness, Interpretability \& Computational Efficiency of Deep models;  Generative modelling (Vision-Language models, Diffusion models); Continual and Lifelong learning}
...
%\cvitem{2022-23}{Tessa Han (PhD candidate, Harvard, supervised by Prof. Hima Lakkaraju) \newline \textit{Local Function Approximation to Characterize Explanations, NeurIPS 2022} \newline \textit{Uncertainty Quantification via Local Linear Approximations, Ongoing} }
%\cvitem{2023}{Usha Bhalla (PhD student, Harvard, supervised by Prof. Hima Lakkaraju) \newline \textit{Dataset Distillation for Interpretability, Ongoing}}
%\cvitem{2017}{Akshayvarun Subramanya (RA, IISc, supervised by Prof. R.V. Babu) \newline \textit{Estimating Confidence for Deep Neural Networks through Density modeling} \newline \textit{Conference on Signal Processing and Communications (SPCOM), 2017}}
%\cvitem{2016}{Lokesh Boominathan (RA, IISc, supervised by Prof. R.V. Babu) \newline \textit{Compensating for Large In-plane Rotations in Natural Images}
