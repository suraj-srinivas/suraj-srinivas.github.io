...
\newline \textit{Neural Information Processing Systems (NeurIPS)} - \textbf{Spotlight}}
\vspace*{0.25em}
...
\newline \textit{International Conference on Learning Representations (ICLR)} - \textbf{Oral}
