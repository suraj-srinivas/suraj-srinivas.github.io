...
- [`splice`](https://arxiv.org/abs/2402.10376): shows that CLIP representations are approximate sparse linear combinations of concept vectors, using this to develop the splice interpretability tool 
...
- [`fullgrad saliency`](https://papers.nips.cc/paper/2019/hash/80537a945c7aaa788ccfcdf1b99b5d8f-Abstract.html): shows that ReLU networks can be exactly decomposed into layer-wise gradient terms, using this property to develop FullGrad saliency maps
