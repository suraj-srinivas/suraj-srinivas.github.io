...
{\newline \footnotesize{{ssrinivas@seas.harvard.edu} $\cdot$ {suuraj.srinivas@gmail.com} $\cdot ~$ Ph: \texttt{(+1)857-995-7812}
}}
}
\familyname{} 
...
\cvsection{about me}
\cvitem{}{I'm a machine learning researcher with 7+ years of academic experience in ML research. My experience includes areas such as interpretable \& explainable machine learning, robust deep learning, computer vision, large language models (LLMs), representation learning and computationally efficient deep learning. My research has been published at machine learning conferences such as ICML, NeurIPS, ICLR, UAI, BMVC and CVPR Workshops.
\newline\newline For more information about my work, check out my webpage: \href{https://suraj-srinivas.github.io}{suraj-srinivas.github.io}
}
%\vspace{0.5cm}
...
\newline \textbf{Research Topics}: Interpretable Machine Learning, LLM Robustness}{}
...
\cvsection{skills}
\cvitem{}{Python, Pytorch, Bash, Git, Slurm}
\cvitem{}{\textbf{Github stars}: \href{https://github.com/suraj-srinivas}{200+}}

\cvsection{selected research publications}

\cvitem{}{\textbf{Total citations: \href{https://scholar.google.com/citations?user=J2JWgKgAAAAJ}{$1900+$} ~ $\mid$~ h-index: $12$}}
...
\cvitem{2023} {Aounon Kumar, Chirag Agarwal, \textbf{Suraj Srinivas}, Soheil Feizi, Hima Lakkaraju. \newline Certifying LLM safety against adversarial prompting.}
...
\cvsection{service}
\cvitem{2023}{Co-organized ``XAI in Action: Past, Present, and Future Applications'' \newline \textit{NeurIPS 2023 workshop}}
