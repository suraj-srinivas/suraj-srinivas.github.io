...
%\usepackage{hyperref}
\setstretch{1.05}
\newcommand{\cvsection}[1]{\vspace{0.2cm}\subsection{\Large{\textit{#1}}}}
%\newcommand{\cvitem}[2]{def}
%----------------------------------------------------------------------------------
%            personal data
%----------------------------------------------------------------------------------
\firstname{\textcolor{darkgray}{\LARGE{\textbf{Suraj Srinivas}}}}
\familyname{}
...
\cvitem{2014}{Ranked 399 (out of $\sim$ 200k candidates) nation-wide in the Graduate Aptitude Test in Engineering for entrance to graduate school in electronics and communications engineering}
...
\cvitem{2010}{Ranked 191 (out of $\sim$ 100k candidates) state-wide in the Karnataka Common Entrance Test for entrance to undergraduate engineering programmes.} 
