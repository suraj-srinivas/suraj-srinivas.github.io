...
{\newline \footnotesize{{suuraj.srinivas@gmail.com} $\cdot$ {suraj.srinivas@us.bosch.com} $\cdot$ \href{https://suraj-srinivas.github.io}{\texttt{suraj-srinivas.github.io}}
}}
}
\familyname{} 
...
\cvsection{about me}
\cvitem{}{Research Scientist at Bosch Research, USA working on vision-language models (VLMs) and video understanding. 10+ years of research experience spanning interpretability, robustness, and efficient deep learning. Published at ICML, NeurIPS, ICLR, and UAI; 3000+ citations, h-index~19.
}
...
\cventry{2024–present}{Research Scientist 2}{}
{\newline Robert Bosch LLC, Sunnyvale, CA, USA}{
    \newline \textbf{Topics}: VLMs, Data curation, Video Understanding
}{}
%{\newline \textbf{Responsibilities}: Machine learning research and development for problems in autonomous driving and industrial automation}{}

\cventry{2022–2024}{Postdoctoral Research Fellow}{}
{\newline Harvard University, MA, USA}
{\newline \textbf{Faculty Advisor}: Prof. Himabindu Lakkaraju}{} 
%\newline \textbf{Responsibilities}: Academic research, Teaching, Supervising graduate student research}{}

\cvsection{education}
\cventry{2017 - 2021}{Doctor of Philosophy}{}
...
\cventry{2020}{Research Intern}{Qualcomm AI Research, Netherlands}{\newline Research on neural network sparsification algorithms}{}{}

\cventry{2016}{Research Intern}{DataGrokr / Verisk Analytics, USA}{\newline Speeding up deep neural network inference using tensor factorization}{}{}

\cventry{2014}{Engineering Intern}{Tonbo Imaging, Bangalore}{}{\newline Implemented image processing algorithms on FPGA for a thermal imaging camera}{}

\cvsection{awards and honors}

\cvitem{2025}{\textbf{Top reviewer} at \textit{Neural Information Processing Systems (NeurIPS)}}
...
\cvitem{}{\textbf{Total citations: \href{https://scholar.google.com/citations?user=J2JWgKgAAAAJ}{$3000+$} ~ $\mid$~ h-index: $19$}}
...
\cvitem{2024} {Aounon Kumar, Chirag Agarwal, \textbf{Suraj Srinivas}, Aaron Li, Soheil Feizi, Hima Lakkaraju. \newline Certifying LLM safety against adversarial prompting. 
...
\cvitem{2024} {Tessa Han*, \textbf{Suraj Srinivas}*, Hima Lakkaraju. 
...
\cvitem{Conferences}{AAAI, CVPR, ECCV, NeurIPS (2020); WACV, ICML, ICCV, NeurIPS (2021);
 \newline ICLR, ICML, NeurIPS (2022); ICLR, AISTATS (2023); ICML, NeurIPS, ICLR (2024, 2025)}
...
\cvitem{2024}{Co-organizer of ``Interpretable AI: Past, Present, and Future'' \newline \textit{NeurIPS 2024 workshop}}
