...
\begin{center}
    \textbf{\Huge \scshape Suraj Srinivas} \\ \vspace{3pt}
    \small
    \faEnvelope \hspace{.5pt} \href{mailto:suuraj.srinivas@gmail.com}{suuraj.srinivas@gmail.com}
    $|$
    \faGithub \hspace{.5pt} \href{https://github.com/arasgungore}{GitHub}
    $|$
    \faGlobe \hspace{.5pt} \href{https://arasgungore.github.io}{Webpage}
\end{center}
...
\section{Education}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeEducationHeading
      {Ecole Polytechnique Federale du Lausanne (EPFL)
      % \normalfont{(Admission rate: 0.09\%)}
      }{Lausanne, Switzerland}
      {Ph.D. in Electrical Engineering}{2017 \textbf{--} 2021}
      {}{}
        % \resumeItemListStart
