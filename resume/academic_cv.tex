...
{\newline \footnotesize{\textit{ssrinivas@seas.harvard.edu} $\cdot$ \textit{suuraj.srinivas@gmail.com} $\cdot$ \href{https://suraj-srinivas.github.io}{\texttt{suraj-srinivas.github.io}}
}}
}
\familyname{} 
...
\cvitem{}{My research aims to \textbf{improve the scientific and mathematical understanding} of deep neural network models and their associated learning algorithms. Practically, I am interested in rigorous methods to build \textbf{interpretable, robust and computationally efficient} models.}
...
\newline \textbf{Research Topics}: Trustworthy machine learning, robustness, large-scale generative models}{}
...
\newline Preliminary version: \textit{ICML 2023 workshop on New Frontiers in Adversarial Machine Learning}}
